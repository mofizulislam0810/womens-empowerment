...
if(isset($_POST['submit'])){
    ...
    $insert_query = "insert into post (date,author,title,images,content) values ('$date','$author_name','$title','$post_image','$content')";
    if(mysqli_query($con,$insert_query)){
    echo "<script>alert('Popular Post published successfuly')</script>";
    echo "<script>window.open('postform.php','_self')</script>";
        }
    }
?>
                ...
                <div class="col-md-12 panel-warning">
                    <div class="content-box-large">
                        <div class="panel-heading">
                            <div class="panel-title text-center">Create Popular Post From</div>
                        </div>
