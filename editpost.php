...
?>
                            <div class="panel-title text-center">Edit Post From</div>
                        </div>
                        <div class="panel-body">
                            <form method="POST" action="editpost.php?edit_form=<?php echo $id; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" class="btn btn-default" id="exampleInputFile1" name="image"
                                            required> <img src="images/<?php echo $image;?>" width="20%" height="15%">
                                        <br><br>
                                    </div>
                                </div>
